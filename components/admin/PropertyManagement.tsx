        ...
        <div className="flex flex-col space-y-3 lg:space-y-0 lg:flex-row lg:items-center lg:justify-between pt-4 border-t border-gray-200">
          ...
          <div className="flex items-center justify-center sm:justify-start lg:justify-end space-x-2">
            ...
            <button
              ...
              className={`p-2 rounded-md ${viewMode === 'grid' ? '!bg-brand-red !text-white font-semibold' : 'text-gray-500 hover:text-gray-700'}`}
              title="Grade"
            >
            ...
            <button
              ...
              className={`p-2 rounded-md ${viewMode === 'list' ? '!bg-brand-red !text-white font-semibold' : 'text-gray-500 hover:text-gray-700'}`}
              title="Lista"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
