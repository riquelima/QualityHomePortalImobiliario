...
const ptTranslations = {
  ...
  "systemModal": {
    ...
    "corsError": {
      ...
      "description": "Seu aplicativo não pode carregar os anúncios porque o servidor Supabase está bloqueando a conexão por segurança. Esta é uma configuração necessária e simples de resolver.",
      "fixInstruction": "Para corrigir, por favor, siga estes passos detalhados no seu painel do Supabase:",
      "step1": "<strong>1. Acesse seu Projeto:</strong> Faça login em <a href='https://supabase.com/' target='_blank' class='text-orange-600 underline'>supabase.com</a> e navegue até o seu projeto.",
      ...
      "step6_code": "Depois de colar, pressione Enter para adicionar a próxima URL se necessário. Adicione as seguintes URLs para cobrir todos os ambientes (desenvolvimento, preview e produção):",
      "step6_urls": "<li><code>http://localhost:3000</code> (para desenvolvimento local)</li><li>Padrões para Vercel/Netlify, como <code>https://*.vercel.app</code> ou <code>https://*.netlify.app</code></li>",
      "step7": "<strong>6. Salve as Alterações:</strong> No <strong>canto inferior direito</strong> da página, você encontrará um botão <strong>'Save'</strong>. Clique nele para aplicar as mudanças.",
      "step8": "<strong>7. Recarregue a Página:</strong> Volte para esta página e atualize-a. Os anúncios devem carregar normalmente.",
      "afterFix": "Se ainda tiver dúvidas, consulte a <a href='https://supabase.com/docs/guides/api/cors' target='_blank' class='text-orange-600 underline'>documentação oficial do Supabase sobre CORS</a>."
    },
    "syncError": {
...
const enTranslations = {
  ...
  "systemModal": {
    ...
    "corsError": {
      ...
      "description": "Your app can't load listings because the Supabase server is blocking the connection for security. This is a necessary and simple configuration to resolve.",
      "fixInstruction": "To fix this, please follow these detailed steps in your Supabase dashboard:",
      "step1": "<strong>1. Access Your Project:</strong> Log in at <a href='https://supabase.com/' target='_blank' class='text-orange-600 underline'>supabase.com</a> and navigate to your project.",
      ...
      "step6_code": "After pasting, press Enter to add the next URL if needed. Add the following URLs to cover all environments (development, preview, and production):",
      "step6_urls": "<li><code>http://localhost:3000</code> (for local development)</li><li>Patterns for Vercel/Netlify, like <code>https://*.vercel.app</code> or <code>https://*.netlify.app</code></li>",
      "step7": "<strong>6. Save Changes:</strong> At the <strong>bottom right</strong> of the page, you will find a <strong>'Save'</strong> button. Click it to apply the changes.",
      "step8": "<strong>7. Reload the Page:</strong> Return to this page and refresh it. The listings should now load correctly.",
      "afterFix": "If you still have questions, refer to the <a href='https://supabase.com/docs/guides/api/cors' target='_blank' class='text-orange-600 underline'>official Supabase documentation on CORS</a>."
    },
    "syncError": {
...
const esTranslations = {
  ...
  "systemModal": {
    ...
    "corsError": {
      ...
      "description": "Tu aplicación no puede cargar los anuncios porque el servidor de Supabase está bloqueando la conexión por seguridad. Esta es una configuración necesaria y sencilla de resolver.",
      "fixInstruction": "Para solucionarlo, por favor sigue estos pasos detallados en tu panel de Supabase:",
      "step1": "<strong>1. Accede a tu Proyecto:</strong> Inicia sesión en <a href='https://supabase.com/' target='_blank' class='text-orange-600 underline'>supabase.com</a> y navega a tu proyecto.",
      ...
      "step6_code": "Después de pegar, presiona Enter para añadir la siguiente URL si es necesario. Añade las siguientes URLs para cubrir todos los entornos (desarrollo, previsualización y producción):",
      "step6_urls": "<li><code>http://localhost:3000</code> (para desarrollo local)</li><li>Patrones para Vercel/Netlify, como <code>https://*.vercel.app</code> o <code>https://*.netlify.app</code></li>",
      "step7": "<strong>6. Guarda los Cambios:</strong> En la <strong>esquina inferior derecha</strong> de la página, encontrarás un botón de <strong>'Save'</strong> (Guardar). Haz clic en él para aplicar los cambios.",
      "step8": "<strong>7. Recarga la Página:</strong> Vuelve a esta página y actualízala. Los anuncios deberían cargarse correctamente.",
      "afterFix": "Si sigues teniendo dudas, consulta la <a href='https://supabase.com/docs/guides/api/cors' target='_blank' class='text-orange-600 underline'>documentación oficial de Supabase sobre CORS</a>."
    },
    "syncError": {
