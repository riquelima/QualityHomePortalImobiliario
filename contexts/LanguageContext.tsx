...
const ptTranslations = {
  ...
  "publishJourney": {
    ...
    "detailsForm": {
      ...
      "aiDescriptionPrompt": "Com base nas seguintes informações de um imóvel, gere uma descrição de anúncio atraente, fluida e profissional em português do Brasil. O texto deve ser convidativo, destacar os pontos fortes e não deve repetir as informações em formato de lista. Crie um parágrafo ou dois que soem naturais para um anúncio imobiliário. Não inclua o preço na descrição. Evite usar o título do anúncio na descrição. O texto deve ser focado nos atributos e benefícios do imóvel.\n\nInformações do imóvel:\n{details}",
  ...
  "publishJourney": {
    ...
    "contactDetails": {
     ...
     "detailsForm": {
      ...
      "aiDescriptionPrompt": "Based on the following property information, generate an attractive, fluid, and professional ad description in Brazilian Portuguese. The text should be inviting, highlight the strengths, and not repeat the information in a list format. Create a paragraph or two that sound natural for a real estate listing. Do not include the price in the description. Avoid using the ad title in the description. The text should focus on the property's attributes and benefits.\n\nProperty Information:\n{details}",
  ...
  "publishJourney": {
    ...
    "contactDetails": {
     ...
     "detailsForm": {
      ...
      "aiDescriptionPrompt": "Basado en la siguiente información de una propiedad, genera una descripción de anuncio atractiva, fluida y profesional en portugués de Brasil. El texto debe ser atractivo, destacar los puntos fuertes y no repetir la información en formato de lista. Crea uno o dos párrafos que suenen naturales para un anuncio inmobiliario. No incluyas el precio en la descripción. Evita usar el título del anuncio en la descripción. El texto debe centrarse en los atributos y beneficios de la propiedad.\n\nInformación de la propiedad:\n{details}",
